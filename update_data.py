...
def main() -> int:
    ...
    try:
        ...
        # C. 台股觀察
        if config.stock_picker_enabled():
        ...
        # D. 美股觀察
        if config.us_stock_picker_enabled():
